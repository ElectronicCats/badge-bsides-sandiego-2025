...
#include "../User/system_ch32v00x.h"
...
void ssd1306_i2c_setup(void) {
  ...
  tempreg |= (SystemCoreClock / SSD1306_I2C_PRERATE) & I2C_CTLR2_FREQ;
  I2C1->CTLR2 = tempreg;
  ...
  tempreg =
      (SystemCoreClock / (2 * SSD1306_I2C_CLKRATE)) & SSD1306_I2C_CKCFGR_CCR;
#else
  // fast mode over 100kHz
  #ifndef SSD1306_I2C_DUTY
  // 33% duty cycle
  tempreg =
      (SystemCoreClock / (3 * SSD1306_I2C_CLKRATE)) & SSD1306_I2C_CKCFGR_CCR;
  #else
  // 36% duty cycle
  tempreg = (SystemCoreClock / (25 * SSD1306_I2C_CLKRATE)) & I2C_CKCFGR_CCR;
