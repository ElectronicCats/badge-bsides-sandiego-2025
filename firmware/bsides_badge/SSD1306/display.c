...
//     {
//         Display_Show_Logo();
//         tmos_start_task(displayTaskID, DISPLAY_CLEAR_EVENT,
//         MS1_TO_SYSTEM_TIME(SHOW_LOGO_DELAY)); return events ^
//         DISPLAY_SHOW_LOGO_EVENT;
//     }
...
//     {
//         printf("x\r\n");
//         tmos_start_task(displayTaskID, DISPLAY_SEND_CHAR_EVENT,
//         MS1_TO_SYSTEM_TIME(100)); return events ^ DISPLAY_SEND_CHAR_EVENT;
//     }
...
//             if (data == 'x')
//             {
//                 tmos_start_task(displayTaskID,
//                 DISPLAY_SHOW_HELLO_WORLD_EVENT,
//                 MS1_TO_SYSTEM_TIME(NO_DELAY));
//             }
//         }
//         tmos_start_task(displayTaskID, DISPLAY_LISTEN_CHAR_EVENT,
//         MS1_TO_SYSTEM_TIME(NO_DELAY)); return events ^
//         DISPLAY_LISTEN_CHAR_EVENT;
//     }
// }
...
//     I2C_AcknowledgedAddress_7bit; I2C_Init(I2C2, &I2C_InitTSturcture);
...
//                 ssd1306_drawPixel(i, SSD1306_H - 1 - (i / (SSD1306_W /
//                 SSD1306_H)), 1);
//             }
//             break;
...
//                 ssd1306_drawLine(SSD1306_W - x, SSD1306_H, 0, SSD1306_H - y,
//                 1); y += SSD1306_H / 8;
//             }
//         }
//         break;
...
//     // tmos_start_task(displayTaskID, DISPLAY_TEST_EVENT,
//     MS1_TO_SYSTEM_TIME(100));
//     // tmos_start_task(displayTaskID, DISPLAY_SHOW_LOGO_EVENT,
//     MS1_TO_SYSTEM_TIME(NO_DELAY));
// }
