/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32v00x_flash.c Author
 *: WCH Version            : V1.0.0 Date               : 2024/03/15 Description
 ...
 *            OB_RST_EN_DT12ms - Reset IO enable (PD7) and  Ignore delay time
 * 12ms OB_RST_EN_DT1ms - Reset IO enable (PD7) and  Ignore delay time 1ms
 *            OB_RST_EN_DT128us - Reset IO enable (PD7) and  Ignore delay time
 * 128us OB_PowerON_Start_Mode - Selects start mode after power on.
...
FLASH_Status FLASH_ROM_ERASE(uint32_t StartAddr, uint32_t Length) {
  ...
  if ((StartAddr & (Size_64B - 1)) || (Length & (Size_64B - 1)) ||
      (Length == 0)) {
